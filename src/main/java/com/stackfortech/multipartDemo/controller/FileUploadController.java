...
public class FileUploadController {
	 ...
	 * IOUtils.copy(file.getInputStream(),outputStream); outputStream.close();
	 * 
	 * String destination = "/Users/deomrinal/desktop/"; // ZipFile zipFile = new
	 * ZipFile(zip); // zipFile.extractAll(destination); zip.delete();
